...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('/check-email', name: 'visitor_authetication_check_email')]
     ...
     */
    #[Route('/reset/{token}', name: 'visitor_authetication_reset_password')]
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, ?string $token = null): Response
    {
        if ($token)
         { 
            ...
            return $this->redirectToRoute('visitor_authetication_reset_password');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        try {
        ...
        } catch (ResetPasswordExceptionInterface $e) 
         {
            ...
            return $this->redirectToRoute('visitor_authetication_check_email');
        }

        $email = (new TemplatedEmail())
            ->from(new Address('monblogdevoyage@gmail.com', 'Yann Boulineau'))
            ->to($user->getEmail())
            ->subject('Réinitialisation de mot de passe sur le blog de Yann Boulineau')
